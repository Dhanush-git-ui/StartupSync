  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-primary/10 via-secondary/10 to-primary/10 py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About StartupSync</h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                ...
                <StatCard number="5000+" label="Startups Helped" />
                <StatCard number="50M+" label="Queries Processed" />
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <ContactCard
                  ...
                  title="Email Us"
                  value="hello@startupsync.com"
                  href="mailto:hello@startupsync.com"
                />
                <ContactCard
...
const ContactCard = ({ icon, title, value, href }: ContactCardProps) => {
  return (
    <a href={href} className="block p-6 bg-card rounded-lg border hover:shadow-md transition-shadow">
      <div className="flex items-center gap-3 mb-3">
        <div className="text-primary">{icon}</div>
        <h4 className="text-lg font-semibold">{title}</h4>
      </div>
